          ...
          <div className="padding-20">
            ...
            {isPickupNowMode ? (
              ...
              calculateGroupOrderPercentage(food, quantitiesByItemName) !==
                ...
                >
                  Groupbuy Progress: {calculateGroupOrderPercentage(food, quantitiesByItemName)}%
                </div>
              )
            )}
          ...
          <div className="padding-20">
            ...
            <div className="add-to-cart-action mt-2">
              ...
              <button
                ...
                onClick={() => navigate("/my-orders", { state: { from: location.pathname + location.search } })}
                style={{
                  pointerEvents: "auto",
                  fontSize: "18px",
                  width: "240px",
              ...
              <button
                className="button text-bold font-size-18"
                onClick={() => navigate("/my-balance", { state: { from: location.pathname + location.search } })}
                style={{
                  pointerEvents: "auto",
                  fontSize: "18px",
                  width: "240px",
