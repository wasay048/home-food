  ...
  const reviews = [
    {
      ...
      date: '2025-08-01',
      name: 'Liam Hawthorne',
      description: "You have to try the Dim Sum here! These dumplings are filled with a burst of flavors that will leave you craving more. Perfect for sharing or enjoying solo! 🥟✨"
    },
    {
      image: User2,
      date: '2025-08-05',
      name: 'Sophie Caldwell',
      description: "If you're in the mood for pizza, the Margherita Pizza is a must! With its fresh basil and gooey mozzarella, it's a slice of heaven! 🍕😍"
    },
    {
      image: User3,
      date: '2025-08-10',
      name: 'Reviewer name',
      description: 'Craving something spicy? The Beef Tacos are packed with flavor and topped with fresh salsa. A delicious choice for taco lovers! 🌮🌶️'
    }
  ];
  return (
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M13.7499 4.80322L9.97336 4.26881L8.28761 0.940677C8.12458 0.667862 7.82468 0.5 7.50028 0.5C7.17588 0.5 6.87597 0.667862 6.71295 0.940677L5.02719 4.26966L1.25064 4.80322C0.920725 4.84924 0.64636 5.07363 0.543084 5.38188C0.439808 5.69013 0.525567 6.02868 0.764246 6.25497L3.49628 8.84616L2.85154 12.5053C2.79531 12.8246 2.93026 13.1472 3.19965 13.3375C3.46905 13.5279 3.82617 13.553 4.12089 13.4022L7.50028 11.6739L10.8779 13.4005C11.1726 13.5513 11.5298 13.5262 11.7992 13.3358C12.0685 13.1455 12.2035 12.8229 12.1473 12.5036L11.5025 8.84446L14.2363 6.25497C14.4744 6.02885 14.56 5.69094 14.4572 5.38312C14.3543 5.0753 14.0809 4.85087 13.7517 4.80407L13.7499 4.80322Z" fill="#FBBC04"/>
</svg>
         </div>
<div className="text">
  <strong>
...
<path d="M10.1667 6.00016C10.1667 6.92063 9.42051 7.66683 8.50004 7.66683C7.57957 7.66683 6.83337 6.92063 6.83337 6.00016C6.83337 5.07969 7.57957 4.3335 8.50004 4.3335C9.42051 4.3335 10.1667 5.07969 10.1667 6.00016Z" stroke="#3FC045"/>
<path d="M12.6481 11.3335C13.5778 12.6592 14.0225 13.3652 13.7576 13.9334C13.731 13.9904 13.6999 14.0454 13.6646 14.098C13.2816 14.6668 12.2916 14.6668 10.3118 14.6668H6.68811C4.7083 14.6668 3.71839 14.6668 3.33536 14.098C3.29999 14.0454 3.26888 13.9904 3.24232 13.9334C2.97742 13.3652 3.42213 12.6592 4.35181 11.3335" stroke="#3FC045" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M9.33831 11.6626C9.11344 11.8791 8.81291 12.0002 8.50017 12.0002C8.18737 12.0002 7.88684 11.8791 7.66197 11.6626C5.60291 9.66736 2.8435 7.4385 4.18918 4.20265C4.91677 2.45304 6.66333 1.3335 8.50017 1.3335C10.337 1.3335 12.0835 2.45305 12.8111 4.20265C14.1551 7.43443 11.4024 9.67423 9.33831 11.6626Z" stroke="#3FC045"/>
</svg>
...
medium-rare, his stir fry to be made with no garlic, his boba to have 50% sweetness, etc.
            </div>
            <div className="custom-accordian">
              <button
                className={`button${activeTab === 'description' ? ' active' : ''}`}
            ...
            <div className="accordian-content">
              {activeTab === 'description' && (
                <div className="description-content">
                 A timeless delicacy from Chinese cuisine, Dim Sum dumplings are handcrafted pockets of flavor, delicately wrapped in thin, translucent dough. Each dumpling is steamed to perfection, preserving the juicy, savory filling inside — typically made with a blend of minced meat, shrimp, or vegetables, infused with aromatic spices and herbs. Served hot in traditional bamboo baskets, they offer a soft, tender bite with every mouthful. Dim Sum is not just a dish — it’s an experience, best enjoyed with dipping sauces like soy, chili oil, or black vinegar. Ideal as a snack, starter, or part of a shared meal, these dumplings bring authentic taste and comforting warmth to your table.
                </div>
              )}
              {activeTab === 'reviews' && (
